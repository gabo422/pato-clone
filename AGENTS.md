...
- **Un solo juego** con 4 gears: Rayo(I)=crimson, Muro(A)=mecano, Trueno(B)=teddy, Viento(M)=duck.
...
- **Avión del gear Rayo agrandado un 50%** (escala x1.5, duck 2.9 → 4.35; SOLO rayo, no afecta a los otros 3 gears). La bala estándar quedó en radio 0.5 (se revirtió el cambio erróneo a 0.75).
...
Prueba los 4 gears de a uno. Reportó (último): quería agrandar el **avión** del Rayo (ya hecho), y revisar que el bajón de FPS no pase en ningún caso de emisión de partículas (hecho, ver decisions.md).

SEGUIR: esperar feedback de Gabriel tras el push del avión Rayo + optimización FPS. Si viene un nuevo reporte, actualizar progress/decisions ANTES y DESPUÉS de trabajar.
