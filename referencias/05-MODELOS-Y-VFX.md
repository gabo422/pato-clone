...
# pato.glb    (27MB) → M-Gear (Viento)    → modelKey: 'duck'
# oso.glb     (10MB) → B-Gear (Trueno)    → modelKey: 'teddy'
# boat.glb    (7MB)  → Bote decorativo
# Crimson.glb (19MB) → I-Gear (Rayo)      → modelKey: 'crimson'
# Mecano.glb  (7.5MB)→ A-Gear (Muro)      → modelKey: 'mecano'
...
# MODELO POR GEAR
# ═══════════════════════════════════════════════════════════════
# I-Gear (Rayo): Crimson.glb, escala ~0.3, scale vec(0.3, 0.3, 0.3)
# A-Gear (Muro): Mecano.glb, escala ~0.3, scale vec(0.3, 0.3, 0.3)
# B-Gear (Trueno): oso.glb, escala ~0.4, scale vec(0.4, 0.4, 0.4)
# M-Gear (Viento): pato.glb, escala ~0.3, scale vec(0.3, 0.3, 0.3)
